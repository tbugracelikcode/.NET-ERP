...
//            #region CashFlowPlanLines Table Created
//            Table CashFlowPlanLinesTable = model.CreateTable(Tables.CashFlowPlanLines);

//            if (CashFlowPlanLinesTable != null)
//            {
//                var properties = (typeof(CashFlowPlanLines)).GetProperties();
...
//                    Column column = new Column(CashFlowPlanLinesTable, property.Name, SqlColumnDataTypeFactory.ConvertToDataType(dbType, maxLength, scale, precision));
//                    column.Nullable = required;

//                    if (isPrimaryKey)
//                    {
//                        Microsoft.SqlServer.Management.Smo.Index pkIndex = new Microsoft.SqlServer.Management.Smo.Index(CashFlowPlanLinesTable, "PK_" + CashFlowPlanLinesTable.Name);
//                        pkIndex.IsClustered = true;
//                        pkIndex.IndexKeyType = IndexKeyType.DriPrimaryKey;
//                        pkIndex.IndexedColumns.Add(new IndexedColumn(pkIndex, property.Name));
//                        CashFlowPlanLinesTable.Indexes.Add(pkIndex);
//                    }

//                    CashFlowPlanLinesTable.Columns.Add(column);
//                }

//                CashFlowPlanLinesTable.Create();
//            }
//            #endregion
