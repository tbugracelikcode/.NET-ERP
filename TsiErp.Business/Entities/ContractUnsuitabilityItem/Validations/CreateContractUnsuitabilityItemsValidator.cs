...
{
    public class CreateContractUnsuitabilityItemsValidator : TsiAbstractValidatorBase<CreateContractUnsuitabilityItemsDto>
    {
        public CreateContractUnsuitabilityItemsValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty()
