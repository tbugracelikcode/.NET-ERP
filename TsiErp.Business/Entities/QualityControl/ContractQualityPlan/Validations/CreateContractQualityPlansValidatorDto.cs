...
{
    public class CreateContractQualityPlansValidatorDto : TsiAbstractValidatorBase<CreateContractQualityPlansDto>
    {
        public CreateContractQualityPlansValidatorDto()
        {
