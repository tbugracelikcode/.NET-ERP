...
{
    public class CreateContractUnsuitabilityReportsValidator : TsiAbstractValidatorBase<CreateContractUnsuitabilityReportsDto>
    {
        public CreateContractUnsuitabilityReportsValidator()
        {
            RuleFor(x => x.FicheNo)
                .NotEmpty()
