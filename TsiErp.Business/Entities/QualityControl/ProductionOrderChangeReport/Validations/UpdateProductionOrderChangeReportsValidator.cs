...
{
    public class UpdateProductionOrderChangeReportsValidator : TsiAbstractValidatorBase<UpdateProductionOrderChangeReportsDto>
    {
        public UpdateProductionOrderChangeReportsValidator()
        {
            RuleFor(x => x.FicheNo)
                .NotEmpty()
