...
{
    public class UpdatePurchaseQualityPlansValidatorDto : TsiAbstractValidatorBase<UpdatePurchaseQualityPlansDto>
    {
        public UpdatePurchaseQualityPlansValidatorDto()
        {
