...
{
    public class CreatePurchasingUnsuitabilityItemsValidator : TsiAbstractValidatorBase<CreatePurchasingUnsuitabilityItemsDto>
    {
        public CreatePurchasingUnsuitabilityItemsValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty()
