...
{
    public class UpdateEmployeeGeneralSkillRecordsValidator : TsiAbstractValidatorBase<UpdateEmployeeGeneralSkillRecordsDto>
    {
        public UpdateEmployeeGeneralSkillRecordsValidator()
        {
            RuleFor(x => x.Code)
               .NotEmpty()
