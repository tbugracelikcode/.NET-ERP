...
{
    public class UpdateGeneralSkillRecordPrioritiesValidator : TsiAbstractValidatorBase<UpdateGeneralSkillRecordPrioritiesDto>
    {
        public UpdateGeneralSkillRecordPrioritiesValidator()
        {
            RuleFor(x => x.Code)
               .NotEmpty()
