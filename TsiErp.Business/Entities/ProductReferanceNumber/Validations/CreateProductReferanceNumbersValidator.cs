...
{
    public class CreateProductReferanceNumbersValidator : TsiAbstractValidatorBase<CreateProductReferanceNumbersDto>
    {
        public CreateProductReferanceNumbersValidator()
        {
