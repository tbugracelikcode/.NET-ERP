...
{
    public interface IEquipmentRecordsAppService : ICrudAppService<EquipmentRecords, SelectEquipmentRecordsDto, ListEquipmentRecordsDto, CreateEquipmentRecordsDto, UpdateEquipmentRecordsDto>
    {
    }
}
