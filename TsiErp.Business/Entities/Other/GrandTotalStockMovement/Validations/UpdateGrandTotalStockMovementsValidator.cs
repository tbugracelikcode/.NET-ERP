...
{
    public class UpdateGrandTotalStockMovementsValidator : TsiAbstractValidatorBase<UpdateGrandTotalStockMovementsDto>
    {
        public UpdateGrandTotalStockMovementsValidator()
        {
