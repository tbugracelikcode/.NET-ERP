...
{
    public class UpdateStandartStationCostRecordsValidator : TsiAbstractValidatorBase<UpdateStandartStationCostRecordsDto>
    {
        public UpdateStandartStationCostRecordsValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty()
