...
{
    public class CreateProductReceiptTransactionsValidator : TsiAbstractValidatorBase<CreateProductReceiptTransactionsDto>
    {
        public CreateProductReceiptTransactionsValidator()
        {
