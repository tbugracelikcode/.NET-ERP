...
namespace TsiErp.Business.Entities.PackingList.Services
{
    ...
    public class PackingListsAppService : ApplicationService<PackingListsResource>, IPackingListsAppService
    {
        ...
        public PackingListsAppService(IStringLocalizer<PackingListsResource> l, IFicheNumbersAppService ficheNumbersAppService, IGetSQLDateAppService getSQLDateAppService, ICurrentAccountCardsAppService currentAccountCardsAppService, IProductReferanceNumbersAppService productReferanceNumbersAppService, INotificationTemplatesAppService notificationTemplatesAppService, INotificationsAppService notificationsAppService) : base(l)
        {
        ...
        public async Task<IDataResult<SelectPackingListsDto>> CreateAsync(CreatePackingListsDto input)
        {
            ...
            var notTemplate = (await _NotificationTemplatesAppService.GetListbyModuleProcessAsync(L["PackingListsChildMenu"], L["ProcessAdd"])).Data.FirstOrDefault();
        ...
        public async Task<IResult> DeleteAsync(Guid id)
        {
            ...
            else
            {
                ...
                var deleteQuery = queryFactory.Query().From(Tables.PackingLists).Delete(LoginedUserService.UserId).Where(new { Id = id },  "");

                var lineDeleteQuery = queryFactory.Query().From(Tables.PackingListPalletCubageLines).Delete(LoginedUserService.UserId).Where(new { PackingListID = id },  "");
                var line2DeleteQuery = queryFactory.Query().From(Tables.PackingListPalletLines).Delete(LoginedUserService.UserId).Where(new { PackingListID = id },  "");
                var line3DeleteQuery = queryFactory.Query().From(Tables.PackingListPalletPackageLines).Delete(LoginedUserService.UserId).Where(new { PackingListID = id }, "");
                ...
                var notTemplate = (await _NotificationTemplatesAppService.GetListbyModuleProcessAsync(L["PackingListsChildMenu"], L["ProcessDelete"])).Data.FirstOrDefault();
        ...
        {
            var queryLine = queryFactory.Query().From(Tables.PackingListPalletCubageLines).Delete(LoginedUserService.UserId).Where(new { Id = id }, "");
        ...
        {
            var queryLine = queryFactory.Query().From(Tables.PackingListPalletLines).Delete(LoginedUserService.UserId).Where(new { Id = id }, "");
        ...
        {
            var queryLine = queryFactory.Query().From(Tables.PackingListPalletPackageLines).Delete(LoginedUserService.UserId).Where(new { Id = id },  "");
        ...
        public async Task<IDataResult<SelectPackingListsDto>> GetAsync(Guid id)
        {
            var query = queryFactory
                   ...
                   .Select<PackingLists>(null)
                    ...
                    .Where(new { Id = id },  Tables.PackingLists);
            ...
            var queryPalletLines = queryFactory
                   ...
                   .Select<PackingListPalletLines>(null)
                    ...
                    .Where(new { PackingListID = id },  Tables.PackingListPalletLines);
            ...
            var queryPalletPackageLines = queryFactory
                   ...
                   .Select<PackingListPalletPackageLines>(null)
                    ...
                    .Where(new { PackingListID = id },  Tables.PackingListPalletPackageLines);
        ...
        public async Task<IDataResult<IList<ListPackingListsDto>>> GetListAsync(ListPackingListsParameterDto input)
        {
            var query = queryFactory
                   ...
                   .Select<PackingLists>(s => new { s.Code, s.Code2, s.DeliveryDate, s.LoadingDate, s.PaymentDate, s.BillDate })
                    ...
                    .Where(null,  Tables.PackingLists);
        ...
        public async Task<IDataResult<IList<SelectPackingListPalletPackageLinesDto>>> GetLinePalletPackageListAsync()
        {
            var query = queryFactory
                   ...
                   .Select<PackingListPalletPackageLines>(null)
                    ...
                    .Where(null, Tables.PackingListPalletPackageLines);
        ...
        public async Task<IDataResult<SelectPackingListsDto>> UpdateAsync(UpdatePackingListsDto input)
        {
            var entityQuery = queryFactory
                   ...
                   .Select<PackingLists>(null)
                    ...
                    .Where(new { Id = input.Id }, Tables.PackingLists);
            ...
            var queryLines = queryFactory
                   ...
                   .From(Tables.PackingListPalletCubageLines)
                  .Select("*")
                    .Where(new { PackingListID = input.Id }, "");
            ...
            var queryLines2 = queryFactory
                 ...
                 .From(Tables.PackingListPalletLines)
                   .Select<PackingListPalletLines>(null)
                    ...
                    .Where(new { PackingListID = input.Id }, Tables.PackingListPalletLines);
            ...
            var queryLines3 = queryFactory
               ...
               .From(Tables.PackingListPalletPackageLines)
                   .Select<PackingListPalletPackageLines>(null)
                    ...
                    .Where(new { PackingListID = input.Id }, Tables.PackingListPalletPackageLines);
                   ...
                   .Select<PackingLists>(null)
                    ...
                    (
                        ...
                        JoinType.Left
                            ...
                            .Where(new { Code = input.Code },  Tables.PackingLists);
            ...
            foreach (var item in input.SelectPackingListPalletCubageLines)
            {
                ...
                {
                    var lineGetQuery = queryFactory.Query().From(Tables.PackingListPalletCubageLines).Select("*").Where(new { Id = item.Id },  "");
            ...
            foreach (var item in input.SelectPackingListPalletLines)
            {
                ...
                {
                    var lineGetQuery = queryFactory.Query().From(Tables.PackingListPalletLines).Select("*").Where(new { Id = item.Id },  "");
            ...
            foreach (var item in input.SelectPackingListPalletPackageLines)
            {
                ...
                {
                    var lineGetQuery = queryFactory.Query().From(Tables.PackingListPalletPackageLines).Select("*").Where(new { Id = item.Id },  "");
            ...
            var notTemplate = (await _NotificationTemplatesAppService.GetListbyModuleProcessAsync(L["PackingListsChildMenu"], L["ProcessRefresh"])).Data.FirstOrDefault();
        ...
        public async Task<IDataResult<IList<SelectPackingListPalletPackageLinesDto>>> GetPackingListLineByPackageId(Guid PackageFicheId)
        {
            var query = queryFactory
                   ...
                   .Select<PackingListPalletPackageLines>(null)
                    ...
                    .Where(new { PackageFicheID = PackageFicheId },  Tables.PackingListPalletPackageLines);
