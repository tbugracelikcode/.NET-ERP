...
{
    public class CreateProductionOrderChangeItemsValidator : TsiAbstractValidatorBase<CreateProductionOrderChangeItemsDto>
    {
        public CreateProductionOrderChangeItemsValidator()
        {
            RuleFor(x => x.Code)
                .NotEmpty()
