...
namespace TsiErp.Business.Entities.BillsofMaterial.Services
{
    ...
    public class BillsofMaterialsAppService : ApplicationService<BillsofMaterialsResource>, IBillsofMaterialsAppService
    {
        ...
        public async Task<IDataResult<IList<SelectBillsofMaterialLinesDto>>> GetLineListbyFinishedProductIDAsync(Guid finishedProductID)
        {
            var queryLines = queryFactory
                  .Query()
                  .From(Tables.BillsofMaterialLines)
                  ...
                  .Join<UnitSets>
                   ...
                   .Where(new { FinishedProductID = finishedProductID }, Tables.BillsofMaterialLines);
