...
namespace TsiErp.ErpUI.Pages.StockManagement.StockNumber
{
    public partial class StockNumbersListPage : IDisposable
    {
        ...
        {
            BaseCrudService = StockNumbersService;
            _L = L;
            #region Context Menü Yetkilendirmesi

            MenusList = (await MenusAppService.GetListAsync(new ListMenusParameterDto())).Data.ToList();
            var parentMenu = MenusList.Where(t => t.MenuName == "StockNumbersChildMenu").Select(t => t.Id).FirstOrDefault();
        ...
        {
            DataSource = new SelectStockNumbersDto()
            {
                Code = FicheNumbersAppService.GetFicheNumberAsync("StockNumbersChildMenu")
            };
        ...
        {
            DataSource.Code = FicheNumbersAppService.GetFicheNumberAsync("StockNumbersChildMenu");
