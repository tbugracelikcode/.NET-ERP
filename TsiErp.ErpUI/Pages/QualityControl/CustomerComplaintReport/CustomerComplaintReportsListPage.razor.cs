...
using TsiErp.Business.Entities.CustomerComplaintReport.Services;
...
namespace TsiErp.ErpUI.Pages.QualityControl.CustomerComplaintReport
{
    public partial class CustomerComplaintReportsListPage
    {
        ...
        {
            GridContextMenu.Add(new ContextMenuItemModel { Text = L["CusCompReportContextAdd"], Id = "new" });
            GridContextMenu.Add(new ContextMenuItemModel { Text = L["CusCompReportContextChange"], Id = "changed" });
            GridContextMenu.Add(new ContextMenuItemModel { Text = L["CusCompReportContextCreate8D"], Id = "create8d" });
            GridContextMenu.Add(new ContextMenuItemModel { Text = L["CusCompReportContextDelete"], Id = "delete" });
            GridContextMenu.Add(new ContextMenuItemModel { Text = L["CusCompReportContextRefresh"], Id = "refresh" });
        }
