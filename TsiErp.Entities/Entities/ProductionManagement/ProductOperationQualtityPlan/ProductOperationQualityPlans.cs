...
namespace TsiErp.Entities.Entities.ProductionManagement.ProductOperationQualtityPlan
{
    /// <summary>
    /// Ürün Operasyon Kartları Kalite Planı
    /// </summary>
    public class ProductOperationQualityPlans : FullAuditedEntity
    {
