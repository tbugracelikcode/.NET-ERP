...
namespace TsiErp.Entities.Entities.QualityControl.OperationalSPC.Dtos
{
    public class CreateOperationalSPCsDto : FullAuditedEntityDto
    {
        /// <summary>
        /// SPC Kodu
        /// </summary>
        ...
        [NoDatabaseAction]
        public List<SelectOperationalSPCLinesDto> SelectOperationalSPCLines { get; set; }
    }
}
